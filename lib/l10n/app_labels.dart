...
class AppLabels {
  ...
  static const helpFaqOfflineA =
      'はい、ほぼ全ての操作がオフラインで利用可能です。\n\n'
      'データはブラウザ内のデータベースに保存されるため、'
      'インターネットに接続していなくても夢・目標・タスクの'
      '閲覧・編集ができます。\n\n'
      '初回起動時のリソースダウンロードと開発者通知の受信のみ'
      'インターネット接続が必要です。';
  ...
  static const helpFaqPrivacyA =
      ...
      '・データはブラウザ内のみに保存され、サーバーに送信されません\n'
      '・広告やトラッキングは一切ありません\n\n'
      '入力したデータが外部に送信されることはありません。';
  ...
  /// v3.1.0: 認証なしプランの説明.
  static const settingsFreePlanDesc =
      'アカウント登録不要・全機能を無料でご利用いただけます';
